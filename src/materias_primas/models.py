...
class Unidad(models.Model):
    nombre = models.CharField(
        "Nombre", blank=False, null=False, max_length=50, unique=True, db_index=True
    )
    nombre_abreviado = models.CharField(
        "Nombre abreviado", null=False, blank=False, max_length=5, unique=True
    )
...
class MateriaPrima(models.Model):
    nombre = models.CharField(
        "Nombre", blank=False, null=False, max_length=150, unique=True
    )
